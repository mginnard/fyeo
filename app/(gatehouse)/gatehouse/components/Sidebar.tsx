...
const nav: { href: string; label: string; icon: LucideIcon }[] = [
  { href: "/gatehouse/overview", label: "Overview", icon: LayoutDashboard },
  { href: "/gatehouse", label: "Flags", icon: Flag },
  { href: "/gatehouse/environments", label: "Environments", icon: Globe2 },
  { href: "/gatehouse/audit", label: "Audit log", icon: ScrollText },
];
        ...
        {nav.map(({ href, label, icon: Icon }) => (
          <Link
            ...
            className={`flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-colors ${
              pathname === href || (href !== "/gatehouse" && pathname.startsWith(href))
