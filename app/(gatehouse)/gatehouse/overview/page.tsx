...
const sections = [
  {
    href: "/gatehouse/overview/getting-started",
    title: "Getting started",
    description: "Step-by-step guide to adding Gatehouse to your Next.js app: copy files, install dependencies, configure env, and wire up your root layout.",
  },
  {
    href: "/gatehouse/overview/creating-and-using-flags",
  ...
  {
    href: "/gatehouse/overview/environments",
  ...
  {
    href: "/gatehouse/overview/code-examples",
    title: "Code examples",
    ...
    <div className="max-w-3xl space-y-10">
      <div>
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Get started with Gatehouse: create flags, configure environments, and
      ...
      <div className="pt-6 border-t border-gray-200 dark:border-white/10">
        <p className="text-sm text-gray-500 dark:text-gray-400">
          View the <Link href="/gatehouse/audit" className="text-indigo-600 dark:text-indigo-400 hover:underline">Audit log</Link> to see who changed which flags and when.
        </p>
      </div>
    </div>
  );
